void Mission_1() {
  ...
  while (Mission_Number == 1) {
    ...
    Serial.print("TOF "); Serial.println(TOF_Distance_Front);
    Serial.print("LEFT "); Serial.println(TOF_Distance_Left);
...
//////////////////// Functions ////////////////////
void map_environment() { // Function takes the sensors values and maps the robots surrounding
  wall_end = false;
  ...
  else if ((TOF_Distance_Left < 40 && TOF_Distance_Left > 15.0 && close_front == false)) {
...
void maze_step() { // Function decides how to move the robot considering the flags raised by last function
