...
void MPU9250ReadAngles_Setup() {
 ...
 /* magcalMPU9250(magBias, magScale);   //note this function to avoid calibration
  ...
  //magcalMPU9250(magBias,magScale);    //note this function to avoid calibration
  //magBias[0] = -101.35; magBias[1] = 344.56; magBias[2] = 0.28; // To skip calibration
  //magScale[0] = 1.00; magScale[1] = 1.01; magScale[2] = 0.99;    // See above ^

  magBias[0] = -79.63; magBias[1] = 308.48; magBias[2] = -10.4; // To skip calibration
  magScale[0] = 1.03; magScale[1] = 0.99; magScale[2] = 0.98;    // See above ^
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnYaw() {
  return yaw + 180.0f;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnPitch() {
  return pitch;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnRoll() {
  return roll;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnAccX() {
  return ax;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnAccY() {
  return ay;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnAccZ() {
  return az;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnGyrX() {
  return gx;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnGyrY() {
  return gy;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnGyrZ() {
  return gz;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnMagX() {
  return mx;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnMagY() {
  return my;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float MPU9250_ReturnMagZ() {
  return mz;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
