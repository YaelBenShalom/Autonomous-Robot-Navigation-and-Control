...
void MPU9250Calculate(float deltat) {
  ...
  yaw *= 180.0f / PI;
  yaw +=
      1.34; /* Declination at Potheri, Chennail ,India  Model Used:	IGRF12
               Help 2016-04-09	1.34° W  changing by  0.06° E per year (+ve
               for west )*/
  roll *= 180.0f / PI;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
void calibrateMPU9250(float *dest1, float *dest2) {
  ...
  if (accel_bias[2] > 0L) {
    accel_bias[2] -=
        (int32_t)accelsensitivity; // Remove gravity from the z-axis
